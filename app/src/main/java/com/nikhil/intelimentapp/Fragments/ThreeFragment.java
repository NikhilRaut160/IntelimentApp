package com.nikhil.intelimentapp.Fragments;
...
import com.nikhil.intelimentapp.Activities.ScenarioOneActivity;
...
public class ThreeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Inflate the layout for this fragment
        ((LinearLayout) view.findViewById(R.id.fragTree)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((ScenarioOneActivity) getActivity()).setDetailsText("Fragment Tree Is Click !");
            }
        });
